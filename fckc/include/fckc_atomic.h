...
static fckc_u32 fckc_u32_cas(fckc_atomic_u32 volatile *atomic, fckc_u32 old_value, fckc_u32 new_value);
static fckc_u32 fckc_u32_load(fckc_atomic_u32 volatile *atomic);
static fckc_u32 fckc_u32_store(fckc_atomic_u32 volatile *atomic, fckc_u32 value);

static fckc_u32 fckc_u32_load_and_add(fckc_atomic_u32 volatile *atomic, fckc_u32 value);
static fckc_u32 fckc_u32_add_and_load(fckc_atomic_u32 volatile *atomic, fckc_u32 value);
static fckc_u32 fckc_u32_load_and_sub(fckc_atomic_u32 volatile *atomic, fckc_u32 value);
static fckc_u32 fckc_u32_sub_and_load(fckc_atomic_u32 volatile *atomic, fckc_u32 value);

static void *fckc_pointer_cas(void *volatile *ptr, void *old_value, void *new_value);
static void *fckc_pointer_load(void *volatile *ptr);
static void *fckc_pointer_store(void *volatile *ptr, void *value);
