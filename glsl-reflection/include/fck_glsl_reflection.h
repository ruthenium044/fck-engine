...
typedef enum fck_glsl_reflection_declaration_qualifier
{
	...
	fck_glsl_reflection_declaration_qualifier_interface_mask =
		fck_glsl_reflection_declaration_qualifier_uniform | fck_glsl_reflection_declaration_qualifier_buffer |
