...
//
//	// vt
//	//temp->reset = (kll_reset_func *)kll_temp_reset;
//	//temp->format = (kll_format_func *)kll_temp_allocator_format;
//	temp->realloc = (kll_realloc_function *)kll_temp_realloc;
//	return temp;
//}
//
//FCK_EXPORT_API void kll_temp_allocator_destroy(kll_temp_allocator *temp)
//{
//	kll_temp_context *context = (kll_temp_context *)temp;
//	kll_temp_page *root = &context->root;
//	kll_temp_page *page = context->pages;
//	while (page != root)
//	{
